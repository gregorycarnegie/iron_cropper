...
use anyhow::Result;
use yunet_utils::{MetadataContext, OutputOptions, append_suffix_to_filename, save_dynamic_image};
...
pub(crate) fn save_processed_crop(
    ...
    out_path: &Path,
    image_path: &Path,
    settings: &yunet_utils::config::AppSettings,
...
mod tests {
    ...
    fn save_processed_crop_writes_image_to_disk() {
        ...
        use yunet_utils::{Quality, config::AppSettings};
