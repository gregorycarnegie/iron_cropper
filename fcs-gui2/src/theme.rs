...
use egui::{Color32, Context, CornerRadius, FontDefinitions, FontFamily, Margin, Shadow, Stroke, Visuals};
...
impl P {
    ...
    pub fn rule_alpha(a: u8)     -> Color32 { Color32::from_rgba_unmultiplied(0x1d, 0x27, 0x42, a) }
    pub fn peach_alpha(a: u8)    -> Color32 { Color32::from_rgba_unmultiplied(0xff, 0xb8, 0x9a, a) }
    pub fn cyan_alpha(a: u8)     -> Color32 { Color32::from_rgba_unmultiplied(0x7b, 0xe0, 0xd6, a) }
    pub fn lime_alpha(a: u8)     -> Color32 { Color32::from_rgba_unmultiplied(0xd8, 0xf0, 0x6a, a) }
    pub fn rose_alpha(a: u8)     -> Color32 { Color32::from_rgba_unmultiplied(0xff, 0x6b, 0x8b, a) }
    pub fn white_alpha(a: u8)    -> Color32 { Color32::from_rgba_unmultiplied(0xff, 0xff, 0xff, a) }
    pub fn black_alpha(a: u8)    -> Color32 { Color32::from_rgba_unmultiplied(0x00, 0x00, 0x00, a) }
}
